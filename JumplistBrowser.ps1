<#
    --------------------------------------------------------------------------------
     Generated by:       Costas Katsavounidis
	 					 https://kacos2000.github.io/Jumplist-Browser/
...
'@
							...
							if ($null -ne $Description)
							{
								...
								elseif (!!$SPS1properties[$ps].TypedProperty[$t].TypedProp.TBytes -and $Description -eq 'System FilterInfo [1E3EE840-BC2B-476C-8237-2ACD1A839B22\2]')
								{
									try
									{
										...
										$UnicodeSting = [System.Text.Encoding]::Unicode.GetString($bytes[4 .. ($UnicodeStingLength - 1)])
	...
	$SFGAOflags = [Ordered]@{
		...
		'0x00000020' = 'CANDELETE'
		'0x00000040' = 'HASPROPSHEET'
		'0x00000100' = 'DROPTARGET'
		'0x00000177' = 'CAPABILITYMASK'
		'0x00000800' = 'PLACEHOLDER'
		'0x00001000' = 'SYSTEM'
		...
		'0x00020000' = 'SHARE'
		'0x00040000' = 'READONLY'
		'0x000FC000' = 'DISPLAYATTRMASK'
		'0x00100000' = 'NONENUMERATED'
		'0x00200000' = 'NEWCONTENT'
		'0x00400000' = 'STREAM'
		'0x00800000' = 'STORAGEANCESTOR'
		'0x01000000' = 'VALIDATE'
		...
		'0x70C50008' = 'STORAGECAPMASK'
		'0x80000000' = 'CONTENTSMASK'
		'0x81044000' = 'PKEYSFGAOMASK'
	}
	
	# Sources:
	# https://github.com/EricZimmerman/ExtensionBlocks/blob/e0cef99c81776641e68a3f436bfcde21f6807334/ExtensionBlocks/Utils.cs
	# https://github.com/raedwulf/portaudio/blob/master/src/hostapi/wasapi/mingw-include/functiondiscoverykeys.h
	$formatIDHashTable = [Ordered]@{
		...
		"904b03a2-471d-423c-a584-f3483238a146\1"	 = "Device Visibility Flags" # 0 = default/ 1 = hidden
		...
		"78C34FC8-104A-4aca-9EA4-524D52996E57\52"    = "DeviceDisplay DiscoveryMethod"
		...
		"78C34FC8-104A-4aca-9EA4-524D52996E57\55"    = "DeviceDisplay IsConnected"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\56"    = "DeviceDisplay IsPaired"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\57"    = "DeviceDisplay Icon"
		...
		"78C34FC8-104A-4aca-9EA4-524D52996E57\70"    = "DeviceDisplay IsLocalMachine"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\71"    = "DeviceDisplay MetadataPath"
		...
		"78C34FC8-104A-4aca-9EA4-524D52996E57\77"    = "DeviceDisplay LaunchDeviceStageFromExplorer"
		...
		"78C34FC8-104A-4aca-9EA4-524D52996E57\81"    = "DeviceDisplay DeviceDescription1"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\82"    = "DeviceDisplay DeviceDescription2"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\83"    = "DeviceDisplay IsNotWorkingProperly"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\84"    = "DeviceDisplay IsSharedDevice"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\85"    = "DeviceDisplay IsNetworkDevice"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\86"    = "DeviceDisplay IsDefaultDevice"
		...
		"78C34FC8-104A-4aca-9EA4-524D52996E57\90"    = "DeviceDisplay Category"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\91"    = "DeviceDisplay Category_Desc_Singular"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\92"    = "DeviceDisplay Category_Desc_Plural"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\93"    = "DeviceDisplay Category_Icon"
		"78C34FC8-104A-4aca-9EA4-524D52996E57\94"    = "DeviceDisplay CategoryGroup_Desc"
		...
		"656a3bb3-ecc0-43fd-8477-4ae0404a96cd\8192"  = "DeviceDisplay Manufacturer"
		"656a3bb3-ecc0-43fd-8477-4ae0404a96cd\8194"  = "DeviceDisplay Model Name"
		"656a3bb3-ecc0-43fd-8477-4ae0404a96cd\8195"  = "DeviceDisplay Model Number"
		"656a3bb3-ecc0-43fd-8477-4ae0404a96cd\8198"  = "Devices Presentation Url"
		"656a3bb3-ecc0-43fd-8477-4ae0404a96cd\12288" = "DeviceDisplay Friendly Name"
		...
		# https://www.magnumdb.com/search?q=1E3EE840-BC2B-476C-8237-2ACD1A839B22
		"1E3EE840-BC2B-476C-8237-2ACD1A839B22\2"	 = "System FilterInfo"
		"1E3EE840-BC2B-476C-8237-2ACD1A839B22\3"	 = "System PerceivedType"
		"1E3EE840-BC2B-476C-8237-2ACD1A839B22\5"	 = "System WordWheel"
		"1E3EE840-BC2B-476C-8237-2ACD1A839B22\6"	 = "System FullText"
	...
	$StockIconIDs = [ordered]@{
		...
		'132' = 'SIID_DRIVEHDDVD'
		'133' = 'SIID_DRIVEBD'
		'134' = 'SIID_MEDIAHDDVDROM'
		'135' = 'SIID_MEDIAHDDVDR'
		'136' = 'SIID_MEDIAHDDVDRAM'
		'137' = 'SIID_MEDIABDROM'
		'138' = 'SIID_MEDIABDR'
		'139' = 'SIID_MEDIABDRE'
		'140' = 'SIID_CLUSTEREDDRIVE'
		...
		'176' = 'Internal Windows 7/8/10/11 icon'
	...
	function Get-Ext_00 # Variant
	{
		...
		elseif ($Signature -eq '1A00EEBB') # Embedded ITemID items
		{
	...
	function Add-fileNodes
	{
		...
		if ($files.Count -ge 1)
		{
			...
			foreach ($file in $files)
			{
				...
				[System.Windows.Forms.Application]::DoEvents()
				# Get associated icon f the file
	...
	$SaveNodestoTxt_Click={
		...
		If (!!$node -and $node.GetNodeCount($false) -ge 1)
		{
			...
			if ($savefiledialog1.ShowDialog() -eq 'OK')
			{
				...
				$Jumplist_Browser.Cursor = 'AppStarting'
				$nodes = (Get-Nodes -nodes $node).Text
				$nodes | Out-String | Out-File -FilePath $savefiledialog1.FileName -Encoding utf8 -NoClobber -Force
				$nodes = $null
				$Jumplist_Browser.Cursor = 'Default'
				$Status.Text = 'Ready'
			}
...
AAAADwMAAAA6fQAAAk1TRnQBSQFMAgEBDgEAARgBAAEIAQABGAEAARgBAAT/ASEBAAj/AUIBTQE2
...

...

...
AAHAAQABAQHAAQABAQGAAgABgAEAAQMBwAEAAQEBwAEAAQEBgAEAAQEBgAEAAQcBwAEAAQMBwAEA
AQEBgAEAAQEBgAEAAQcBwAEAAQcBwAEAAQEBwAEPAf8BgAEPAf8BwAEAAQcBwAEAAQEG/wHAAQAB
DwHAAQABAQb/AcABAAEPAcABAAEDBv8B8AEAAT8B8AEAAQcM/ws='))
	#endregion
...

...
Af8B9QH/AfgB/wHyAf8B9QH/Ae8B/wHxAf8B6wH/Ae4B/wHoAf8B6gH/AeQF/wMCAQMIAAMhAS8B
UAFTAVIBkwGuAf8B5wH/AYwB/wHXAf8BiQH/AdkB/wFmAf8BkwH/AR8BtQFPGf8DAgEDCAADAgED
...
Af8BsQGdAYkB/wGxAZ0BiQH/AbEBnQGJAf8BsQGdAYkB/wGrAZYBgAH6CAAF/wHeAaYC/wHmAakC
...
'))
	#endregion
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB