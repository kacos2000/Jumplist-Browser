...
'@
	...
	function Get-Ext_C3 # 3 split
	{
		...
		try
		{
			...
			if ($Flags -eq 'D5') # path, name & description
			{
			...
			<# elseif ($Flags -in 'D1', '81') #>
			{
				...
				if ($String.count -ge 2 -and $String[0].length -ge 1)
				{
					$PathUnicode = $String[0]
					$NameUnicode = $String[1]
				}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD1VpW7LdldkLOI
# 3bv9mE0CkkMcUAczDuzvrlFTBGYofaCCKI0wggQyMIIDGqADAgECAgEBMA0GCSqG
...
# AQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIIWE/bySBe4RsfLvf0h9l2G/B46lh20I
# bjZZg3vZPGUNMA0GCSqGSIb3DQEBAQUABIICAHaboJFnZC/FI+bvsGBWDjTO23L1
# evBRGgdTNkTqmlm8JKd4ykZCMrNTWpX9He9o/jqv7vy67ofQlL+ryxhM/J3HVkev
# vQDRNHS1g1hiG2YX6JmDdQCE4pePVlHYuhlPnnEu/hqg2KoIEwae2yH+U4z4RUOV
# r8c67/gp0ZZGHQ1ZHyzws4R271EBZZPAtI6Ga5IT4kT24Og1VD2UQgtaa4+GwFtC
# LEd2zhy/Cu1Z87i1KibX0sDb+Q/VMAdtzASji/1HrYuAfpZLT+dt1j36SzsiTQE/
# U//uiN8DsRBCAsd3Q5P09carRd9LXal98ha+I6VX65WKPD+i1e0xsCAHfriU2uFl
# Pj4eJaVN3iIA1t4eyjP5+frJRQAAYMHUHH37zpkxzu12n1jzpBtkDmNS3rXim3P0
# WNXHZOaZj+R9+S8zcjsQvF0Y1hSzaIfceQv7waFKtqZUjRmbK6tkIIjqZgMOLAmh
# cWOgpo5W53ZoLuCWveFfR0miQLuigWO0CLuvaqJGv1kOGpIuWuk3+bVFVMa/Xauo
# xr4HTNb0ZPKwRUCZ0wVNSbp0vMOKVWAKZKgpMVzDghAa4rj6ILsbmIRByGpGAjxt
# ls1qW4rUSzBIcJSEuxrx2jj7qZMysXY3xgwOLgWiZlgEwkR4AVnB3upLASoAze0u
# prcv99lOiQ/630zmoYIDbDCCA2gGCSqGSIb3DQEJBjGCA1kwggNVAgEBMG8wWzEL
...
# hvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzEyMTIwMTEzNDJaMCsGCSqGSIb3DQEJ
# NDEeMBwwCwYJYIZIAWUDBAIBoQ0GCSqGSIb3DQEBCwUAMC8GCSqGSIb3DQEJBDEi
# BCD/fJNiEQvDfvweUfsu0NRjSWq+cy6EWj/S8YNvk+LrrjCBpAYLKoZIhvcNAQkQ
...
# p6EZTQwcV7gpMA0GCSqGSIb3DQEBCwUABIIBgKiPI+b+Xi/RIrEx4iQZuaTYSKpc
# AEl4KykiwGbDw4gp2SF9Szuvddqk8HOSnX2mgDpV1cTOAmTlysrJajfySBQKhngZ
# n3q8JoDRJ+C/eu4ZBHCPI9cyC5OuOkCUHbPyan6q1vTWqn3Ivf/9SHBCVob7K6tc
# UT4VPee32gL0VseGeuV0dKXNjbEYw9Es/weHeBu1hmD/aMP+si8wiHpkAWoXwN4+
# hoJSnVJ5W6LWsHhlOIjHIrVTuAh794JIECNB95ZImAxTWYIz+Fv6GGb7gHUIja7X
# glECE5b8ii3IoQkbE2A2wDGqAFcFUML/pJ6bYSduSr83SM1/lhGViqxNxxNEBLMI
# CvAXp2IoCxmzN8o3RPgNxZRbwF/KtOd4fl+CoaQoiWz2CLC7CNFHGgs2p4PFJeNA
# sAT3F7b4uSZCUDZ+W/C+HnriMVrH0CLpIZa9Qgmt0mnZqPcgnlbaW6vzdSExhGzC
# l+EhUQEC74M6+yrvm2I4zYCt5YeSJpe15IpYvw==
